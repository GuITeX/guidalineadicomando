...
% oi_begin_comment
% Ho un dubbio sul livello di questo paragrafo; credo anche che sia necessario
...
Per questo inseriamo in una cartella i sorgenti ed un file che contenga le righe
...
con il file \filestyle{header\_temp}; infine con \verb!mv header_temp $i;!
